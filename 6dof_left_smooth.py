...
step = 3          #Distance in mm for each step in Inverse Kinematic mode, lower = more accurate but might start shaking due to slow calculations
...
-  a3 * pitbasecos * pitarmsin +  a2 * pitbasesin + a1)
    ...
    print(x_pos_fork, y_pos_fork, z_pos_fork)
...
next_coordinate_linear( 160, -100,  235,    0,    0,    0, 700) 
next_coordinate_linear( 160, -195,  235,    0,    0,    0, 700) 
next_coordinate_linear( 280, -195,  235,  -10,    0,    0, 700) 
next_coordinate_linear( 280, -195,  280,  -10,    0,    0, 700) 
next_coordinate_linear( 160, -195,  280,  -10,    0,    0, 700)
next_coordinate_linear( 160, -195,  360,  -10,    0,    0, 700)
next_coordinate_linear( 160,  150,  360,    0,    0,    0, 700)
next_coordinate_linear( 280,  150,   60,    0,    0,    0, 700)
wait(2000)
next_coordinate_linear( 280,  150,  300,    0,    0,    0, 700)
next_coordinate_linear( 280, -195,  300,  -10,    0,    0, 700)
next_coordinate_linear( 280, -195,  235,  -10,    0,    0, 700) 
next_coordinate_linear( 160, -195,  235,    0,    0,    0, 700) 
wait(10000000)
